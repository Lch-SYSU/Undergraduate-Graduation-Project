...
with open(r'D:\学习\毕设\数据\data\HELA\SRR3589958.T.txt') as f1:
    ...
    # 读入数据
    data = pd.read_table(r'D:\学习\毕设\数据\data\HELA\GC0.8 ENSG.txt', encoding = 'UTF-8', engine = 'python')
    ...
    # 将数据框写入文件中
    writing.to_csv(r'D:\学习\毕设\数据\data\HELA\GC0.8 TPM SRR3589958.csv', sep = ' ', na_rep = 'NULL')
